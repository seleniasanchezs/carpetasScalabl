...
<head>
    ...
    <meta property="og:title" content="Problem Interview" />
    <meta property="og:description" content="There are two data-driven ways to validate the hypotheses laid out in your business model: active listening and testing. The problem interview is the almighty tool to help you pin down your customer segment. Take a look at the free taster module of our Online Course, and get to work on the soft skills of empathy and active listening." />
    ...
    <meta name="description" content="There are two data-driven ways to validate the hypotheses laid out in your business model: active listening and testing. The problem interview is the almighty tool to help you pin down your customer segment. Take a look at the free taster module of our Online Course, and get to work on the soft skills of empathy and active listening." />
    <meta name="theme-color" content="#613b5e" />
    <title>Problem Interview</title>
    ...
    <section class="container container-estrecho">
        <div>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 columna-1 mt-3 px-4 px-lg-0 col-1-mobile">
                    ...
                    <div class="py-3 px-0 contenedor_texto">
                        <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                            <p class="my-3">There are <b>two data-driven ways to validate the hypotheses laid out in the business model: </b> <u>active listening</u> and <u>testing</u>. </p>
                        </div>

                        <p>The 💬 <b>problem interview</b> is the almighty tool to help you gather the information you need by listening to your customers.</p>
                        <p>Staying curious and humble, and learning to <b>master the soft skill of empathy</b>, will allow you to get a set of customers who have a common pain to open up about their problem and provide you with valuable insights on how to solve it.</p>
                        
                        <!-- Contenedor video -->
                        <div class="contenedor_video">
                            <!-- Contenedor Iframe -->
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/616946454?h=45b222db77" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <!-- / Contenedor Iframe -->
                        </div>
                        <!-- /Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 mb-4 contenedor_texto">
                            <p>How often do you engage in conversation with people you are not acquainted with and try to know them better? Do you ever truly listen to them without an ulterior motive (ie. transactional)? Do you pay attention to what they are saying or are you constantly anticipating your next move?</p>
                            <p>More often than not, problem interviews show us that <b>our assumptions are completely wrong</b>. What is more, they often reveal new relevant opportunities. The data you collect through them feeds a relentless process of <b>iterations</b> (tweaks to some of the business model's components) and/or <b>pivots</b> (more radical changes), which must continue until the <u>alignment between the business model and the core desires or problems of the chosen segment</u> is achieved.</p>
                            ...
                            <div class="contenedor_banner d-none d-lg-block my-4">
                                <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank"> 
                                    <img src="/freetrial/img/banners/banner-claim-descuento-celeste.gif" alt="Banner enroll now, get a 20% discount">
                                </a>
                            </div>
                            <!-- Contenedor banner desktop-->

                            <!-- Contenedor banner mobile -->
                            <div class="contenedor_banner d-block d-lg-none my-3">
                                <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank">
                                    <img src="/freetrial/img/banners/banner-claim-descuento-celeste-mobile.gif" alt="Banner enroll now, get a 20% discount">
                                </a>
                            </div>
                            <!-- Contenedor banner mobile-->

                            <h2 class="mb-3">Pin down your customer segment</h2>
                            <p>We believe there is no product or service for which a fitting customer segment can’t be found. The key to finding your prospects is to lay out a set of hypotheses that exhaustively describe the segment’s characteristics, including but not limited to their most relevant problem or desire, the circumstances in which they experience it, behavioral patterns, personal traits, etc. </p>
                            
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">Having a full-fledged – though still conjectural – description of your customers is essential for knowing <b>where to find your prospects</b> when you go out to meet them.</p>
                            </div>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/616948659?h=b442553835" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <div class="mt-4 contenedor_texto">
                            <p>Here’s a “flashcard” for<u> customer segment delimitation</u>:</p>
                            <p>1. Identify <b>desire or need</b> → 2. Imagine a full set of <b>characteristics</b> to portray the customer that, hypothetically, would most value the solution your product/service has to offer → 3. Define <b>where, when, how</b> to find them (<b>circumstances</b> in which they experience the aforementioned desire or need) → 4. Set up a <b>database</b>.</p>
                            <h2>The secret to acquiring ninja-level 🥷 interviewing skills</h2>
                            <p>Actually, there is no big secret , just a staple recipe that works. As with any other skill, the only way to learn or perfect it is through <b>reflexive, repeated and relentless exercise</b>. </p>
                            <p>At this stage in our methodology you will simply start contacting every one of the potential customers in your segment whom you managed to enter into your database, inviting them to join you for a coffee, or to schedule a friendly video call or a shared morning run – <u>unlock your creativity and try different approaches</u>. </p>
                            <p>Keep in mind that the focus of your interviews is to gain an in-depth understanding of who these people are and what their wants and needs are, so forget about your product or service and <b>proceed with empathy, not with an agenda</b>. </p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <!-- Contenedor Iframe -->
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/616953121?h=b0eadff16a" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <!-- / Contenedor Iframe -->
                        </div>
                        <!-- /Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4">
                           <h2>— Excited about our course?  —</h2>
                           <p>If you like what you’ve seen so far, <b>you are welcome to share this free taster module with your friends</b>. Just copy and and paste the following sign-up link on Facebook, Instagram, Twitter, email or WhatsApp: <a href="https://www.scalabl.com/startup" target="_blank">https://www.scalabl.com/startup</a></p>
                        </div>
                        <!-- Contenedor texto -->
                        ...
                        <div class="contenedor_consultas-unidades-barra  px-0 px-lg-4" id="contenedor_consultas-altura">
                            ...
                            <div class="d-flex align-items-center mt-5">
                                <a href="https://scalabl.com/freetrial/businessmodels">
                                    <img src="/freetrial/img/iconos/prev.png" alt="Ir a la anterior unidad">
                                </a>
                                <!-- UnitUnidades desktop -->
                                ...
                                <div class="barra_unidades barra_unidadesMobile position-relative d-block d-lg-none d-xl-none">
                                    ...
                                    <div class="item_unidad_1 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-desbloqueado.png" alt="Unidad realizada">
                                        <h2 class="mt-3 mb-1 text-center">Unit 4</h2>
                                        <p class="text-center">Business models</p>
                                    </div>
                                    <div class="item_unidad_2 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-bloqueado.png" alt="Unidad desbloqueada">
                                        <h2 class="mt-3 mb-1 text-center">Unit 6</h2>
                                        <p class="text-center">Your customer as co-creator</p>
                                    </div>
                                </div>
                                <!-- Unidades mobile -->
                                <a href="https://scalabl.com/freetrial/mvp">
                            ...
                            <div class="contendor_unidades d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownUnidadPrevia">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/businessmodels">Previous</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownSiguienteUnidad">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/mvp">Next</a></li>
                                    </ul>
                                </div>
                                <!--/ Desktop -->
                                <!-- Mobile -->
                        ...
                        <div class="mt-4 contenedor-inscribite px-2 px-lg-4">
                            <p class="mb-1 pt-2"><b>When you enroll in the full course you will get</b></p>
                            <ul class="pe-1 list-unstyled">
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> <b>State-of-the-art tools </b> for customer segmentation</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> Tips to develop ninja-level interviewing skills and <b>achieve killer results</b> through your problem interviews</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> <b>Fictional scenario training and real-life case studies</b> which will inspire you, help you maximize results and spot profitable opportunities</li>
                                <li><i class="fas fa-arrow-right me-2"></i> <b>Techniques and practical exercises</b> for the development of the fundamental <b>soft skills</b> of active listening and empathy</li>
                            </ul>
                            <!-- Get it touch -->
                            <div class="mt-3 contenedor_texto">
                                <p class="mb-1">— We would love to get <b>your feedback</b> on this taster module and we are happy to help if you have any questions so far 🤙<b> Get in touch with our team</b> —</p>
                ...
                <!--/ Contenedor compartir la prueba -->
