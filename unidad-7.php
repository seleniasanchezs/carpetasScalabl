...
<head>
    ...
    <meta property="og:description" content="The previous steps in our methodology have prepared you to enter the fascinating though uncanny world of sales. Now it’s time to design your staple branding and sales materials, which you’ll want to develop as quickly and cost-effectively as possible. When you enroll in our full Online Course, we’ll tell you how." />
    ...
    <meta name="description" content="The previous steps in our methodology have prepared you to enter the fascinating though uncanny world of sales. Now it’s time to design your staple branding and sales materials, which you’ll want to develop as quickly and cost-effectively as possible. When you enroll in our full Online Course, we’ll tell you how." />
    <meta name="theme-color" content="#613b5e" />
    <title>Get Ready to Sell</title>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 columna-1 mt-3 px-4 px-lg-0 col-1-mobile">
                    ...
                    <div class="py-3 px-0 contenedor_texto">
                        ...
                        <!-- Contenedor texto -->
                        <div>
                           <p class="mb-1">Before entering <b>the fascinating though uncanny world of sales</b>, make sure you check the following boxes:</p>
                           <ul class=" list-unstyled">
                               <li>✔ You have clearly defined your purpose, strategy and laid out a coherent business model.</li>
                               <li>✔ You have pinned down your customer segment – you know exactly where and how to find them – with a significant pain or gain that needs to be catered to.</li>
                               <li>✔ You have created an MVP to solve it which has a good customer acceptance rate and a validated price.</li>
                           </ul>
                           <p>When you do, it’s time to design your staple <b> branding and sales materials</b>, among them: name, logo, business card (physical or digital), website, social media channels, sales PDF.</p>
                        </div>
                        <!-- Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            ...
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617142780?h=5d6abe4f1d" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <!-- / Contenedor Iframe -->
                        </div>
                        <!-- /Contenedor video -->
                        ...
                        <div class="mt-4 contenedor_texto">
                            <p>Branding and sales materials are meant to <b>build awareness</b> of your business, to show people that your brand exists and promises to deliver some kind of value to them. Anyone that considers buying from you will want to corroborate that your business is real and understand what it has to offer.</p>
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">At this point, entrepreneurs consistently demonstrate an unfortunate ability to procrastinate, self-sabotage 😵‍💫 and hinder their progress. This is a tricky stage, as they can easily get weighed down by the unrealistic ambition to achieve the full-fledged, definitive DNA of their brand right from the beginning – even worse if they buy into the fancy briefs of traditional branding and marketing agencies.</p>
                            </div>
                            <p>The way to counter this unnecessary evil is to create your branding and sales materials as <b>quickly and cost-effectively</b> as possible – even better if you design them yourself, not depending on deliverables from third parties. </p>
                            <p>After all, no avid customer will stop buying from you on account of your unpolished sales materiales. There will be more than enough time to make improvements down the road.</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617143849?h=a108a8d007" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 contenedor_texto">
                            <p>Now hit the play button on the next video and take a look at some smart <b>landing pages</b> created by former participants in our course. </p>
                            <p>Bear in mind that some of these have undergone several iterations already and are far more complex than your initial landing page needs to be. At first, always keep it simple.</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617144265?h=842426be51" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 pb-2">
                           <p>  Hit the “Next Unit” button below to move forward to the next step  of our methodology — get ready to roll up your sleeves to start kneading the sales dough! 💪</p>
                        </div>
                        <!-- Contenedor texto -->
                            ...
                            <div class="d-flex align-items-center mt-5">
                                ...
                                <div class="barra_unidades barra_unidadesMobile position-relative d-block d-lg-none d-xl-none">
                                    ...
                                    <div class="item_unidad_2 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <h2 class="mt-3 mb-1 text-center">Unit 8</h2>
                                        <p class="text-center">Sales roadmap</p>
                                    </div>
                                </div>
                                <!-- Unidades mobile -->
                                <a href="https://scalabl.com/freetrial/sales">
                            ...
                            <div class="contendor_unidades d-flex justify-content-between align-items-center" >
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownUnidadPrevia">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/mvp">Previous</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownSiguienteUnidad">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/sales">Next</a></li>
                                    </ul>
                                </div>
                                <!--/ Desktop -->
                                <!-- Mobile -->
                   ...
                   <!-- Contenedor banner dto + inscribite-->
                       ...
                       <div class="contenedor_banner d-none d-lg-block my-4">
                            <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank"> 
                                <img src="/freetrial/img/banners/banner-claim-descuento.gif" alt="Banner enroll now, get a 20% discount">
                            </a>
                        </div>
                        <!-- Contenedor banner desktop-->
                        ...
                        <div class="contenedor_banner d-block d-lg-none my-2">
                            <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank">
                                <img src="/freetrial/img/banners/banner-claim-descuento-mobile.jpg" alt="Banner enroll now, get a 20% discount">
                            </a>
                        </div>
                        <!-- Contenedor banner mobile-->
                    <div class="mt-4 contenedor-inscribite px-2 px-lg-4 mb-3">
                        <p class="mb-1 pt-2"><b>When you enroll in the full course you will get</b></p>
                        <ul class="pe-1 pb-2 list-unstyled">
                            <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> A list of <b>recommended resources</b> to create your branding and sales materials in record time and cost-effectively – or for free!</li>
                            <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> <b>Expert advice</b> on the musts and must-nots for your entry-level landing page, name, logo, etc.</li>
                            <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> Lifetime access to the <b>Scalabl Global Community</b>, a collaborative and supporting horizontal network of 1500+ graduates from 50+ countries – founders, owners and talented business professionals in almost every industry.</li>
                        </ul>
                        <p>Curious about our graduates? Discover more about them <a href="https://scalabl.com/community/" target="_blank">here</a>.</p>
                    </div>
