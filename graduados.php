    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="mb-4 titulo">Graduados</h1>
                <div class="container-fluid">
                    <form class="my-2 my-md-0 ">
                        <div class="form-group row">
                            <input id="tb_buscar" data-buscar="graduado" class="form-control form-control-sm input-lg barra-buscar inline-block" type="text" placeholder="Buscar" aria-label="Search">
                            <button class="btn btn-scalabl btn-sm ml-2 inline-block" id="btn_buscar">Buscar</button>
                        </div>
                        <div class="form-group row">
                            <div class="form-check form-check-inline ml-2">
                                <input class="form-check-input" type="radio" name="tipoBuscar" id="nya" value="0" checked>
                                <label class="form-check-label" for="nya">Nombre y apellido</label>
                            </div>
                            <div class="form-check form-check-inline ml-2">
                                <input class="form-check-input" type="radio" name="tipoBuscar" id="info" value="1">
                                <label class="form-check-label" for="info">Información</label>
                            </div>
                            <div class="form-check form-check-inline ml-2">
                                <input class="form-check-input" type="radio" name="tipoBuscar" id="prof" value="2">
                                <label class="form-check-label" for="prof">Profesión</label>
                            </div>
                        </div>
                    </form>
                </div>
