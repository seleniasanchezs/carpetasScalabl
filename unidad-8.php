...
<head>
    ...
    <meta property="og:title" content="Sales Roadmap" />
    <meta property="og:description" content="​​Sales are a lifelong learning process. Every insight gained through sales should feed into your strategy and business model, which you will continue to refine ensuring that it remains virtuous after any tweaks or major changes. In the early stages of a startup, selling should take up to 80-90% of the founders’ time – only the founders can discover a successful and repeatable sales roadmap." />
    ...
    <meta name="description" content="​​Sales are a lifelong learning process. Every insight gained through sales should feed into your strategy and business model, which you will continue to refine ensuring that it remains virtuous after any tweaks or major changes. In the early stages of a startup, selling should take up to 80-90% of the founders’ time – only the founders can discover a successful and repeatable sales roadmap." />
    <meta name="theme-color" content="#613b5e" />
    <title>Sales Roadmap</title>
...
<body>
    ...
    <section class="container container-estrecho">
        <div>
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 columna-1 mt-3 px-4 px-lg-0 col-1-mobile">
                    <div>
                        <h1>
                            <b>Achieve a successful and predictable sales roadmap</b>
                        </h1>
                    </div>
                    ...
                    <div class="py-3 px-0">
                        ...
                        <div class="contenedor_texto">
                            <p>This last tool will make you rediscover what sales are. Sales 💰, yet another elusive business concept which few entrepreneurs are able to define clearly.</p>
                            <p>At our onsite education programs, we often play <b>a game</b> called <b>“The unsellable marker”</b>, where participants are challenged to create and apply strategies they have learned throughout the course in order to sell a marker pen to a school teacher.</p>
                            <p>Guess what? <em>No one ever got it right</em>.</p>
                            <p><em>(Enter ghost of SALES 👻 bearing its maleficent grin ).</em></p> <!-- NOTE: HACER CLASE CON CURSIVA para no usar <EM></EM> -->
                            <p><b>"What are sales?"</b> is the perplexing question that we have to address. Once again, a seemingly simple concept hides an unexpected complexity…</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            ...
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617144823?h=3ff4af0ec8" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <!-- / Contenedor Iframe -->
                        </div>
                        <!-- /Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="contenedor_texto mt-4">
                            <h2>— Since we’re talking about sales… 😉 —</h2>    
                            <p>If you like what you’ve seen so far and can’t wait to sign up for the <a href="https://scalabl.com/course/" target="_blank">full course</a>, you can now enroll with a <b>20% discount</b>.</p>        
                        </div>
                        <!--/ Contenedor texto -->
                       ...
                       <div class="contenedor_banner d-none d-lg-block my-4">
                        ...
                        <!-- Contenedor texto -->
                        <div class="contenedor_texto mt-4">
                            <p>Back to our game: so the team has already agreed on the definition of sales that should be handed down to the new sales rep. Now let’s see how they fare at “The Unsellable Marker” challeng</p>
                            <p>Try to draw your own conclusions from their performance in the game.</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617146713?h=ee6b32d744" width="640" height="360" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <div class="mt-4 contenedor_texto">
                            <p>What are the participants not seeing? What could they do differently? What aspects of sales are they not taking into account? Why can’t they find a way to sell?</p>
                            <p>🔥 What the hell are sales?!? Sales are <b>a lifelong learning process</b>.</p>
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">At this stage, our focus is still on learning so there's no need to rush. We continue to capitalize on our insights by feeding them into our strategy and performing adjustments to continuously refine our business model, ensuring that it remains virtuous after any tweaks or major changes – iterations or pivots. </p>
                            </div>
                            <p>Hit the play button below and discover why the participants in the game failed to sell the marker.</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617149066?h=de094ccbb6" width="640" height="360" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 contenedor_texto">
                            <p>In the early stages of a startup, <b>selling should take up to 80-90% of the founders’ time</b> – only the founders can discover a successful and repeatable sales roadmap. Later, when a sales team can finally be hired and trained to implement the process, the founders’ time will be increasingly allocated to management.</p>
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">Many entrepreneurs put in massive amounts of stamina 😓 into developing their business model, product and brand, but fail at sales because they lack the resilience to fail multiple times before getting it right or are overcome by fear of rejection.</p>
                            </div>
                            <p>But selling is just another skill that can be learned and perfected through the use of the right tools. A skill that is key to achieving your purpose and one that undoubtedly pays off (no pun intended)! 😝</p>
                        </div>
                        <!--/ Contenedor texto -->

                        <!-- Contenedor consultas / siguiente unidad / barra unidades -->
                        <div class="contenedor_consultas-unidades-barra mt-2 px-0 px-lg-4" id="contenedor_consultas-altura7-8">
            
                            <!-- Contenedor barra unidades -->
                            <div class="d-flex align-items-center mt-5">
                                <a href="https://scalabl.com/freetrial/brandingandsales">
                                ...
                                <div class="barra_unidades position-relative d-none d-lg-block d-xl-block">
                                    ...
                                    <div class="item_unidad_1 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-desbloqueado.png" alt="Unidad desbloqueada">
                                    ...
                                    <div class="item_unidad_2 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <h2 class="mt-3 text-center">Unit 7</h2>
                                        <p class="text-center">Get ready to sell!</p>
                                    </div>
                                    <div class="item_unidad_3 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <h2 class="mt-3 text-center">Unit 8</h2>
                                        <p class="text-center">Sales roadmap</p>
                                    </div>
                                    <div class="item_unidad_4 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-gift.png" alt="Unidad bloqueada">
                                        <h2 class="mt-3 text-center">Special offer <span class="d-block">+ gift</span></h2>
                                    </div>
                                </div>
                                <!--/ Unidades desktop -->
                                ...
                                <div class="barra_unidades barra_unidadesMobile position-relative d-block d-lg-none d-xl-none">
                                    ...
                                    <div class="item_unidad_1 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-desbloqueado.png" alt="Unidad desbloqueada">
                                        <h2 class="mt-3 mb-1 text-center">Unit 7</h2>
                                        <p class="text-center">Genera ventas predecibles</p>
                                    </div>
                                    <div class="item_unidad_2 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        <img src="/freetrial/img/iconos/icono-gift.png" alt="Unidad bloqueada">
                                        <h2 class="mt-3 mb-1 text-center">Special offer + gift</h2>
                                    </div>
                                </div>
                                <!-- Unidades mobile -->
                                <a href="https://scalabl.com/freetrial/congrats">
                            ...
                            <div class="contendor_unidades d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownUnidadPrevia">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/brandingandsales">Previous</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownSiguienteUnidad">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/congrats">Next</a></li>
                                    </ul>
                                </div>
                                <!--/ Desktop -->
                                <!-- Mobile -->
                        ...
                        <div class="contenedor_banner d-none d-lg-block my-4">
                            <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank"> 
                                <img src="/freetrial/img/banners/banner-enroll-rosa.jpg" alt="Banner enroll now, get a 20% discount">
                            </a>
                        </div>
                        <!-- Contenedor banner desktop-->
                        ...
                        <div class="contenedor_banner d-block d-lg-none my-2">
                            <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank">
                                <img src="/freetrial/img/banners/banner-enroll-rosa-mobile.jpg" alt="Banner enroll now, get a 20% discount">
                            </a>
                        </div>
                        <!-- Contenedor banner mobile-->
                        <div class="mt-4 contenedor-inscribite px-2 px-lg-4">
                            <p class="mb-1 pt-2"><b>When you enroll in the full course we will provide you with</b></p>
                            <ul class="pe-1 list-unstyled">
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> A thorough explanation of the <b>sales roadmap tool</b> and how to design and implement processes that power up your sales</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> Instructions and recommendations about <b>how to design tests and measure results</b> to refine and improve your sales strategy – until you find the repeatable and predictable way to turn 1 USD 💸 put into selling into more than 1 USD 💰</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> A better understanding of who to sell and who not to sell to – <b>choosing your prospects wisely</b> makes all the difference!</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> Five fundamental life and career planning tools plus a memorable account of the Scalabl <b>"Gekko" moment</b> – our own version of the "Eureka!" (minus the math wiz leaping out of the bath and running naked through Syracuse 😅)</li>
                            </ul>
                            <p>— Don't hesitate to reach out if you have any questions about this module or need any assistance with the enrollment form 🤙 <b>Get in touch with our team</b> —</p>
    ...
    <!-- Barra flotante -->
    <a class="link-barra-flotante" href="https://scalabl.com/course/" target="_blank">
        <div class="barra-flotante text-center position-fixed py-3">
            <h3 class="text-center my-2 me-3">Read more about <b> the full course</b> <img class="ps-2" src="/plataformapruebagratuita/img/iconos/flecha-right.png" alt=" Flecha"></h3>
        </div>
    </a>
    <!-- / Barra flotante -->
    ...
    <!-- Modal compartir -->
        ...
        <script type="text/javascript">
            fbq('trackCustom', 'FinishedTrial', {promotion: 'prueba_gratuita_completada'});
        </script>
