...
<head>
    ...
    <meta property="og:title" content="End Trial" />
    <meta property="og:description" content=" Congratulations! You have come to the end of this free taster module, but your learning path has only just started. Sign up for the next session of our Online Course and discover what you’re capable of when you equip yourself with the full extent of Scalabl’s powerful methodology and toolkit for entrepreneurship and innovation." />
    ...
    <meta name="description" content=" Congratulations! You have come to the end of this free taster module, but your learning path has only just started. Sign up for the next session of our Online Course and discover what you’re capable of when you equip yourself with the full extent of Scalabl’s powerful methodology and toolkit for entrepreneurship and innovation." />
    <meta name="theme-color" content="#613b5e" />
    <title>End Trial</title>
    ...
    <section class="container container-estrecho">
        <div>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 columna-1 mt-3 px-4 px-lg-0">
                    <div>
                        <h1>
                            <b>Congrats! You have completed the free taster module</b>
                        </h1>
                        </a>
                    </div>
                    ...
                    <div class="py-3 px-0 contenedor_texto">
                        ...
                        <!-- Contenedor texto -->
                        <div>
                            <p>You have come to the end of this free taster module, but your learning path has only just started.</p>
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3"><b>Sign up for our upcoming online program and discover what you’re capable of when you equip yourself with the full extent of Scalabl’s powerful methodology and toolkit for entrepreneurship and innovation.</b></p>
                            </div>
                            <p>The next session starts  <?php fechas_num(1, 0, 2); ?> and we would love it if you choose to join us and become a part of 💜 our global network.</p>
                        </div>
                        <!-- Contenedor texto -->
                       ...
                       <div class="contenedor_banner d-none d-lg-block my-4">
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4">
                            <p class="mb-1"><b>When you enroll in the full course you’ll get access to</b></p>
                            <ul class="pe-1">
                                <li class="mb-1">The <b>verified track</b> featuring <b>13 modules, 120+ videos, exercises and reading materials</b></li>
                                <li class="mb-1"><b>Scheduled Zoom meet-ups</b> with your classmates, your instructor Francisco and members of the Scalabl team</li>
                                <li class="mb-1">Your cohort’s communication channels on popular messaging and social media platforms – <b>intensive networking practice</b> and opportunities for collaboration from day one through the end of the course and beyond!</li>
                                <li class="mb-1">Lifetime membership to the <b>Scalabl Global Community</b>, a horizontal network of <b>1500+ graduates from 50+ countries</b> – founders, owners and talented business professionals in almost every industry</li>
                                <li class="mb-1"><b>Member-exclusive offers and discounts</b> on Scalabl education programs, books and networking activities</li>
                                <li class="mb-1"><b>Certificate </b> of completion</li>
                            </ul>
                            <p>🙏 Thank you for your interest in our <b>Online Course in Entrepreneurship and Innovation</b>.</p>
                            
                           <div class="mt-4">
                                <h2>— We'd love to get your feedback about this taster module —</h2>
                                <p>Please help us get better by answering an ultra short survey. We will reward you with 🎁 <b>a pdf guide to auto-evaluate your entrepreneurial skills</b>.</p>
                           </div>

                           <button id="btn_encuesta" data-tf-popup="JPj4gqt2" style="all:unset;font-family:Helvetica,Arial,sans-serif;display:inline-block;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;background-color:#5b455b;color:#FFFFFF;font-size:18px;border-radius:25px;padding:0 33px;font-weight:bold;height:50px;cursor:pointer;line-height:50px;text-align:center;margin:0;text-decoration:none;">Take me to the survey</button><script src="//embed.typeform.com/next/embed.js"></script>
                        </div>
                        <!-- Contenedor texto -->

                        <!-- Contenedor consultas / siguiente unidad / barra unidades -->
                        <div class="contenedor_consultas-unidades-barra" id="contenedor_consultas-altura-9-0">
                            ...
                            <div class="d-flex align-items-center mt-5">
                                ...
                                <div class="barra_unidades position-relative d-none d-lg-block d-xl-block">
                                    ...
                                    <div class="item_unidad_1 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <p class="text-center">Your customer as co-creato</p>
                                    </div>
                                    ...
                                    <div class="item_unidad_4 item_unidades position-absolute d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <h2 class="mt-3 text-center">Special offer + gift</h2>
                            ...
                            <div class="contendor_unidades d-flex flex-column flex-lg-row justify-content-between align-items-center contendor_unidades10">
                                <a href="https://scalabl.com/freetrial/sales">
                                    <button class="btn_anteriorUnidad btn_unidad py-2 px-2 px-lg-3 me-2 mb-lg-0 mb-3">Previous</button>
                                </a>
                                <a href="https://scalabl.com/course/">
                                    <button class="btn_siguienteUnidad btn_unidad py-2 px-2 px-lg-3">Ready to enroll ? </button>
                                </a>
                            </div>
                            <!--/ Contenedor siguiente unidad -->
                            <!-- Contenedor banner desktop -->
                            <div class="contenedor_banner d-none d-lg-block my-4">
                                <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank"> 
                                    <img src="/freetrial/img/banners/banner-full-course.gif" alt="Banner enroll now, get a 20% discount">
                                </a>
                            </div>
                            <!-- Contenedor banner desktop-->
                            ...
                            <div class="contenedor_banner d-block d-lg-none my-2">
                                <a href="https://scalabl.com/course/?utm_source=freetrial&utm_medium=banners" target="_blank">
                                    <img src="/freetrial/img/banners/banner-full-course-mobile.jpg" alt="Banner enroll now, get a 20% discount">
                                </a>
                            </div>
                            <!-- Contenedor banner mobile-->
                        <!--/ Contenedor consultas / siguiente unidad / barra unidades -->
