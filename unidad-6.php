...
<head>
    ...
    <meta property="og:title" content="Co-create with Your Customers" />
    <meta property="og:description" content="You’ve laid out a business model, filled a database with prospects matching your well-delimited customer segment, validated their pain or desire through problem interviews. Now you’re ready to move onto the next step in our methodology and put your efforts into designing and building the Minimum Viable Product (MVP)." />
    ...
    <meta name="description" content="You’ve laid out a business model, filled a database with prospects matching your well-delimited customer segment, validated their pain or desire through problem interviews. Now you’re ready to move onto the next step in our methodology and put your efforts into designing and building the Minimum Viable Product (MVP)." />
    <meta name="theme-color" content="#613b5e" />
    <title>Co-create with Your Customers</title>
        ...
        <div class="position-relative">
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 columna-1 mt-3 px-4 px-lg-0 col-1-mobile">
                    <div>
                        <h1>
                            <b> Get your customers to co-create with you </b>
                        </h1>
                    </div>
                    ...
                    <div class="py-3 px-0 contenedor_texto">
                        ...
                        <div class="contenedor_texto">
                            <h2>The solution interview and the MVP</h2>
                            <p>By this point, you have laid out your business model ✔, set up a database ✔ with prospects matching your well-delimited customer segment ✔, and tested and validated ✔ the existence and severity of their pain or desire through the problem interviews.</p>
                            <p>Only now can you move onto the next step in our methodology and put your efforts into designing and building the <b>Minimum Viable Product (MVP)</b>, which you will then present to the previously interviewed prospects as a solution to their problem.</p>
                            
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">The <b>solution interview</b> is aimed to put the MVP to the test by offering the customer a test run and asking for feedback – an acute perception and interpretation of these fresh insights will allow you to rethink and calibrate your business model, and your product or service.</p>
                            </div>
                            <p>Hit the play button and learn more about how to get your customers to co-create with you.</p>
                        ...
                        <div class="contenedor_video">
                            ...
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617139649?h=b9e1c09978" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <!-- / Contenedor Iframe -->
                        </div>
                        <!-- /Contenedor video -->
                        ...
                        <div class="mt-4 contenedor_texto">
                            <div class="contenedor_conBorde  my-3  ps-2 ms-lg-3">
                                <p class="my-3">Infatuation with the product 🖤 is one of the capital sins that loom over entrepreneurs. <b>Stay humble</b>, gather <b>feedback</b> and identify opportunities while you let your customers shape the product or service with you – and even for you! </p>
                            </div>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <!-- Get it touch -->
                        <div class="mt-4 contenedor_texto">
                            <h2>— We’d love to hear from you 🤙 Get in touch with our team —</h2>
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/618009911?h=88aae85c86" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 contenedor_texto">
                            <h2>Price-testing and product design</h2>
                            <p>Additionally, solution interviews offer the perfect opportunity for price-testing. By identifying patterns in how the interviewed prospects respond to your offer, you will be able to <b>develop a smart pricing strategy</b> for your product or service.</p>
                        </div>
                        <!--/ Contenedor texto -->
                        ...
                        <div class="contenedor_video">
                            <div class="contendor_iframe d-flex align-items-center">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/617141933?h=2cc5f6b38f" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <!-- / Contenedor video -->
                        ...
                        <!-- Contenedor texto -->
                        <div class="mt-4 contenedor_texto">
                           <p>Here’s a useful set of recommendations:</p>
                           <ul>
                               <li>Make the customer the star, not your solution.</li>
                               <li>Let the customer interact with the MVP while you <b>ask open questions</b> and listen. You will use the <b>information, insights and patterns</b> to build the first shippable MVP.</li>
                               <li>Try to identify whether the problem (desire or pain) you detected is real and if you understood it correctly.</li>
                               <li>Pay attention to non-verbal language.</li>
                               <li>Document the exact comments – there are nuances to every expression.</li>
                               <li>Avoid asking leading questions that prompt or encourage the answers you want.</li>
                               <li>This is still not a sales interview. <u>Your goal is to learn</u>.</li>
                               <li>Validate pricing. Communicate your price without flinching and study the customer’s reaction. </li>
                           </ul>
                           <p>Now move on to the next unit to find out <b>which materials are needed to power up your sales</b> and how to create them cost-effectively and in record time.</p>
                        </div>
                        <!--/ Contenedor texto -->

                        <!-- Contenedor consultas / siguiente unidad / barra unidades -->
                        <div class="contenedor_consultas-unidades-barra  px-0 px-lg-4">
                            ...
                            <div class="contendor_unidades d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownUnidadPrevia">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/probleminterview">Previous</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown d-none d-lg-block d-md-block d-xl-block">
                                    ...
                                    <ul class="dropdown-menu text-center p-0" aria-labelledby="dropdownSiguienteUnidad">
                                        ...
                                        <li><a class="dropdown-item py-2" href="https://scalabl.com/freetrial/brandingandsales">Next</a></li>
                                    </ul>
                                </div>
                                <!--/ Desktop -->
                                <!-- Mobile -->
                        ...
                        <!-- Contenedor banner dto desktop-->
                        <div class="contenedor_banner d-none d-lg-block my-4">
                            <a href="https://scalabl.com/course?utm_source=freetrial&utm_medium=banners" target="_blank">
                                <img src="/freetrial/img/banners/banner-next-session.gif" alt="Banner next session starts soon">
                            </a>
                        </div>
                        <!-- Contenedor banner dto desktop-->
                        <!-- Contenedor banner dto mobile-->
                        <div class="contenedor_banner d-block d-lg-none">
                            <a href="https://scalabl.com/course?utm_source=freetrial&utm_medium=banners" target="_blank">
                                <img src="/freetrial/img/banners/banner-next-session-mobile.jpg" alt="Banner next session starts soon">
                            </a>
                        </div>
                        <!-- Contenedor banner dto mobile-->
                        
                        <div class="mt-4 contenedor-inscribite px-2 px-lg-4">
                            <p class="mb-1 pt-2"><b>When you enroll in the full course you will learn</b></p>
                            <ul class="pe-1 mb-1 list-unstyled">
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> How minimum should your minimum viable product (MVP) be and how you can <b>build it cost-effectively and minimize risk</b></li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> <b>Real-life killer-MVP examples</b> and why companies like Dropbox, Zappos, Buffer, etc. succeed</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> An <b>unconventional approach to value and price</b> and how to develop a smart pricing strategy by maximizing value for every stakeholder</li>
                                <li class="mb-1"><i class="fas fa-arrow-right me-2"></i> <b>How to extract and collect data</b> at the solution interview and how to draw conclusions from it to improve your strategy, business model, pricing and product</li>
                            </ul>
                        </div>
